...
export default function ProjectUsersPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="sticky top-4 z-20 -mx-4 flex flex-col gap-3 bg-background px-4 sm:-mx-6 sm:flex-row sm:items-start sm:justify-between sm:px-6 lg:-mx-8 lg:px-8">
