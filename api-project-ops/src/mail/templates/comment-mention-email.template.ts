...
export function commentMentionEmailTemplate(params: {
  ...
  const bodyHtml = `
    <p style="margin:0 0 12px 0;font-size:14px;color:#374151;line-height:1.6;">
      in <strong>${escapeHtml(workspaceName)}</strong>
    </p>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td style="padding:14px 16px;background-color:#f8fafc;border-left:3px solid #2563eb;border-radius:4px;font-size:14px;line-height:1.6;color:#374151;">
