...
export class CreateWorkItemDto {
  ...
  @ApiProperty({
    required: false,
    example: 'Pipeline',
    description: 'Name prefix (e.g. the module name the work item belongs to)',
  })
  @IsOptional()
  @IsString()
  @MaxLength(100)
  ...
  @ApiProperty({
    required: false,
    description: 'WorkType this item is classified as (task/incident/bug)',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiProperty({
    required: false,
    description: 'Workspace member responsible for QA',
  })
  @IsOptional()
  @IsUUID()
  qaAssigneeId?: string;
